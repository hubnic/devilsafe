									...
									<table class="table table-striped">
										...
										<tbody>
											<tr>
												...
												<td class="col-xs-2">
												<form method="post" target="_blank"  id="relevePdf" action="<c:url value="/relevePdf" />" role="form">
													<input type="hidden" id="idCompte" name="idCompte" value="${comptes.idCompte}" readonly>
													<button type="submit"> 
